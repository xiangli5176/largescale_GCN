...
#             For test purpose, we let the clusters to follow specific order
    ...
    # iterate through epoch and also the clusters
    def train(self, epoch_num=10, learning_rate=0.01, weight_decay = 0.01, mini_epoch_num = 1, train_batch_num = 2, select_group_size = 1):
        """
            *** Training a model. ***
            epoch_num:  number of total training epoch number
            learning rate: learning rate during training
...
#             For test purpose, we let the clusters to follow specific order
            ...
            for cluster in train_clusters:
                ...
                if len(minibatch_data_train_group) > select_group_size:
                    minibatch_data_train_group = random.sample(minibatch_data_train_group, select_group_size)
