...
if __name__ == '__main__':
    ...
    step0_generate_clustering_machine(data, dataset, intermediate_data_folder, origin_train_batch_num, validation_ratio = 0.10, test_ratio = 0.20, mini_cluster_num = 32, round_num = 2)
