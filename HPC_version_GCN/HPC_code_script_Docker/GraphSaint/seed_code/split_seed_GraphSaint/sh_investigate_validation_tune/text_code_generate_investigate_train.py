    ...
    with open(src_file, "r") as readin:
        with open(dst_file, "w") as writeout:
            for line in readin:
                ...
                elif line.strip().startswith("model_epoch_list"):
                    line = " " * 4 + "model_epoch_list = [" + str(epoch_idx) + "]\n"
...
if __name__ == '__main__':
    ...
    trainer_id_list = list(range(3))

    epoch_num_list = list(range(5, 16, 5))
    ...
    src_file_pbs = src_data_folder + "step3_investigate_validation_epoch_idx_0.sh"
    ...
    for tune_val_label in tune_val_label_list:
        ...
        for trainer_id in trainer_id_list:
            ...
            for epoch_idx in epoch_num_list:
                ...
                dst_file_pbs = trainer_id_folder + "step3_investigate_validation_epoch_idx_" + str(epoch_idx) + ".sh"
