...
if __name__ == '__main__':
    ...
    src_data_folder = datapath + "train_tune_origin/"
    src_file_py = src_data_folder + "formal_investigate_train_id_0.py"
    src_file_pbs = src_data_folder + "step2_investigate_train_id_0.sh"
    ...
    for tune_val_label in tune_val_label_list:
        ...
        for trainer_id in trainer_ids:
            ...
            dst_file_pbs = tune_val_folder + "step2_investigate_train_id_" + str(trainer_id) + ".sh"
