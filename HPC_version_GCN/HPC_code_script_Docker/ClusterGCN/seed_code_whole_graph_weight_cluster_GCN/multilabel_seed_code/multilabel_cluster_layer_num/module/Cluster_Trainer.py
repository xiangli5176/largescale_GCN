...
#         print('used layers are: ', str(self.input_layers))
    ...
    def do_forward_pass(self, tr_train_nodes, tr_edges, tr_edge_weights, tr_features, tr_target):
        ...
        predictions = self.model(tr_edges, tr_features, edge_weight = tr_edge_weights)
...
#             For test purpose, we let the clusters to follow specific order
            ...
            for cluster in train_clusters:
                ...
                tr_edges, tr_edge_weights, tr_features, tr_target, tr_train_nodes, tr_validation_nodes = minibatch_data_train
...
#             For test purpose, we let the clusters to follow specific order
            ...
            for cluster in train_clusters:
                ...
                tr_edges, tr_edge_weights, tr_features, tr_target, tr_train_nodes, _ = minibatch_data_train
    ...
    def whole_cpu_test(self):
        ...
        y_pred = test_model(test_edges, test_features, edge_weight = test_edge_weights)[test_nodes]
