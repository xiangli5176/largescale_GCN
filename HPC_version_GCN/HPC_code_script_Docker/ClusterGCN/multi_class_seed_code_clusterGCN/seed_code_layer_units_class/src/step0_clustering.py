...
if __name__ == '__main__':
    ...
    step0_generate_clustering_machine(data, dataset, intermediate_data_folder, origin_train_batch_num, validation_ratio = 0.25, test_ratio = 0.25, mini_cluster_num = 512, round_num = round_num)
