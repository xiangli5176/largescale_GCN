...
if __name__ == '__main__':
    ...
    trainer_ids = list(range(3))
    # source path to copy from
    src_data_folder = datapath + "test_tune_origin/"
    src_file_py = src_data_folder + "formal_run_test_id_0.py"

    src_file_pbs = src_data_folder + "step7_test_run_id_0.sh"
    ...
    for tune_val_label in tune_val_label_list:
        ...
        for trainer_id in trainer_ids:
            ...
            dst_file_pbs = tune_val_folder + "step7_test_run_id_" + str(trainer_id) + ".sh"
