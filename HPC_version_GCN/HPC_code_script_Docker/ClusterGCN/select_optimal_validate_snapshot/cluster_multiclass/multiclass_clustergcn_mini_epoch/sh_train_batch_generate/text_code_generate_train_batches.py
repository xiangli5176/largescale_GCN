...
if __name__ == '__main__':
    ...
    batch_group_ids = list(range(group_num))
    trainer_ids = [0]  # for each 0 id, actually it executes for multi id
    # source path to copy from
    src_data_folder = datapath + "batch_origin/"
    src_file_py = src_data_folder + "formal_train_batches_0.py"
    src_file_pbs = src_data_folder + "step1_generate_train_batch_0.sh"
    ...
    for batch_group_id in batch_group_ids:
        ...
        for trainer_id in trainer_ids:
            ...
            dst_file_pbs = batch_group_folder + "step1_generate_train_batch_" + str(trainer_id) + ".sh"
