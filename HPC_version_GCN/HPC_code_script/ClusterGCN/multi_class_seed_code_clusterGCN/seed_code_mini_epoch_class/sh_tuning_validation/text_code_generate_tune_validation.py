...
if __name__ == '__main__':
    ...
    src_file_py = src_data_folder + "formal_run_validation_id_0.py"

    src_file_pbs = src_data_folder + "step4_validation_run_id_0.batch"
    ...
    for tune_val_label in tune_val_label_list:
        ...
        for trainer_id in trainer_ids:
            dst_file_code_name = "formal_run_validation_id_" + str(trainer_id) + ".py"
            dst_file_py = tune_val_folder + dst_file_code_name
            generate_src_file(dst_file_py, src_file_py, tune_val_label, trainer_id)
            dst_file_pbs = tune_val_folder + "step4_validation_run_id_" + str(trainer_id) + ".batch"
