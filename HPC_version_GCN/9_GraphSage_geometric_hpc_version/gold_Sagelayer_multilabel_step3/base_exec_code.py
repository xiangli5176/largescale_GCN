...
def set_clustering_machine(data, dataset, intermediate_data_folder, validation_ratio = 0.05, test_ratio = 0.85, train_batch_num = 2):
    """
...
#     clustering_machine.split_cluster_nodes_edges(test_ratio, validation_ratio, partition_num = train_batch_num)
    ...
    t1 = time.time()
    clustering_machine.split_whole_nodes_edges_then_cluster(validation_ratio, test_ratio, train_batch_num = train_batch_num)
