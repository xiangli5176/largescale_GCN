...
def set_clustering_machine_train_batch(intermediate_data_folder, sample_num = 10, batch_range = (0, 1), info_folder = 'info_train_batch/', info_file = 'train_batch_size_info.csv'):
    """
