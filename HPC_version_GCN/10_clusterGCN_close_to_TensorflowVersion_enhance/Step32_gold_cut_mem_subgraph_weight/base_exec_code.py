...
def set_clustering_machine(data, dataset, intermediate_data_folder, validation_ratio = 0.10, test_ratio = 0.22, 
                           train_batch_num = 2, mini_cluster_num = 16, round_num = 1):
    """
