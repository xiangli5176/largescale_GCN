...
if __name__ == "__main__":
    # datapath = '/users/PAS1069/osu8206/GCN/Datasets/GraphSaint/' # for hpc
    datapath = '/home/xiangli/projects/tmpdata/GCN/GraphSaint/'   # for local machine
    ...
    prepare(working_dir, train_data, train_params, arch_gcn, num_clusters = 16, batch_num = 8)
