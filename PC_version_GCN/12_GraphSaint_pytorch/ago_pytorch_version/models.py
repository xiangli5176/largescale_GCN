...
class GraphSAINT(nn.Module):
    def __init__(self, num_classes, arch_gcn, train_params, feat_full, label_full, cpu_eval=False):
        ...
        # here we discriminate between multi-label and multi-class tasks
        # self.sigmoid_loss:  if true:  multi-label task;  if false:  multi-class task
    ...
    def forward(self, node_subgraph, adj_subgraph):
        ...
        # if multi-label task: label_subg and label_subg_converted are the same!
