...
def set_clustering_machine(data, dataset, intermediate_data_folder, test_ratio = 0.05, validation_ratio = 0.85, train_batch_num = 2, mini_cluster_num = 16, round_num = 2):
    """
...
#     clustering_machine.split_cluster_nodes_edges(test_ratio, validation_ratio, partition_num = train_batch_num)
    ...
    t1 = time.time()
    clustering_machine.split_cluster_nodes_edges(test_ratio, validation_ratio, mini_cluster_num = mini_cluster_num, train_batch_num = train_batch_num, round_num = round_num)
...
def set_clustering_machine_train_batch(intermediate_data_folder, train_batch_num = 2, \
...
#     check_folder_exist(intermediate_data_folder)  # if exist then delete
    ...
    t2 = time.time()
    clustering_machine.mini_batch_train_clustering(intermediate_data_folder, train_batch_num = train_batch_num, \
...
def Cluster_tune_validation_run(gcn_trainer):
