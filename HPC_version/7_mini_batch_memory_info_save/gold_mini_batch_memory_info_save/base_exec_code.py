...
def step1_generate_train_batch(image_data_path, intermediate_data_path, partition_nums, layers, train_frac = 1.0, train_part_num = 2):            
    for partn in partition_nums:
        for GCN_layer in layers:
            net_layer = len(GCN_layer) + 1
            hop_layer = net_layer
...
if __name__ == '__main__':
    ...
    step2_generate_validation_batch(image_data_path, intermediate_data_folder, partition_nums, layers, valid_part_num = 2)
