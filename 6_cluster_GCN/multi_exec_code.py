...
def step3_run_train_validation_batch(data, data_name, dataset, image_data_path, intermediate_data_path, partition_nums, layers, \
...
if __name__ == '__main__':
    ...
    step3_run_train_validation_batch(data, data_name, dataset, image_data_path, intermediate_data_folder, partition_nums, layers, \
                dropout = 0.1, lr = 0.0001, weight_decay = 0.1, mini_epoch_num = 20, valid_part_num = 2)
